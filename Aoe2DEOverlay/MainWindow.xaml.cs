...
public partial class MainWindow : Window
{
    ...
    private void ShowMockData()
    {
        ...
        var samples = new[]
        {
            new { Name = "Gualord", ProfileId = 1, Slot = 7, Color = 1, Team = 1, OneVsOne = 939, TeamRating = 1039, Wins = 70, Losses = 65, Streak = (int?)2, Civs = new[] { "Persians", "Vikings", "Huns", "Mayans", "Berbers" } },
            new { Name = "Hera", ProfileId = 2, Slot = 8, Color = 2, Team = 2, OneVsOne = 2612, TeamRating = 1548, Wins = 124, Losses = 61, Streak = (int?)-3, Civs = new[] { "Mayans", "Mongols", "Huns", "Vikings", "Chinese" } },
            new { Name = "Liereyy", ProfileId = 3, Slot = 5, Color = 3, Team = 1, OneVsOne = 2580, TeamRating = 1602, Wins = 91, Losses = 58, Streak = (int?)2, Civs = new[] { "Ethiopians", "Malians", "Mongols", "Hindustanis", "Franks" } },
            new { Name = "Yo", ProfileId = 4, Slot = 6, Color = 4, Team = 2, OneVsOne = 1784, TeamRating = 1640, Wins = 88, Losses = 72, Streak = (int?)0, Civs = new[] { "Britons", "Japanese", "Saracens", "Byzantines", "Teutons" } },
            new { Name = "Viper", ProfileId = 5, Slot = 3, Color = 5, Team = 1, OneVsOne = 2475, TeamRating = 1778, Wins = 118, Losses = 54, Streak = (int?)null, Civs = new[] { "Vikings", "Poles", "Burmese", "Incas", "Aztecs" } },
            new { Name = "TaToH", ProfileId = 6, Slot = 4, Color = 6, Team = 2, OneVsOne = 2301, TeamRating = 1711, Wins = 109, Losses = 66, Streak = (int?)-1, Civs = new[] { "Spanish", "Portuguese", "Turks", "Koreans", "Slavs" } },
            new { Name = "Vinchester", ProfileId = 7, Slot = 1, Color = 7, Team = 1, OneVsOne = 2148, TeamRating = 1682, Wins = 97, Losses = 69, Streak = (int?)2, Civs = new[] { "Tatars", "Magyars", "Lithuanians", "Bulgarians", "Cumans" } },
            new { Name = "MbL", ProfileId = 8, Slot = 2, Color = 8, Team = 2, OneVsOne = 2056, TeamRating = 1594, Wins = 82, Losses = 73, Streak = (int?)0, Civs = new[] { "Goths", "Celts", "Franks", "Huns", "Futurelanders" } }
        };
    ...
    private void SetPlayerGroups(IEnumerable<OverlayPlayerViewModel> players)
    {
        _players.Clear();
        _teamGroups.Clear();
        foreach (var team in players.OrderBy(player => player.Team).ThenBy(player => player.Color).GroupBy(player => player.Team))
        {
